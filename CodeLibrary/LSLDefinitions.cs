...
namespace LogSpiralLibrary.CodeLibrary
{
    ...
    public class ModDefinition : EntityDefinition
    {
        ...
        public override string DisplayName => IsUnloaded ? Language.GetTextValue("Mods.ModLoader.Unloaded") : ModLoader.GetMod(Name).DisplayName;//SequenceSystem.conditions[Name].Description.ToString();
    }
    ...
    public class ConditionDefinition : EntityDefinition
    {
        ...
        public override string DisplayName => IsUnloaded ? Language.GetTextValue("Mods.ModLoader.Unloaded") : (Name == "None" ? "None" : SequenceSystem.conditions[Name].Description.ToString());
    }
    ...
    //public class SequenceDefinition : EntityDefinition
    //{
    //    public override int Type
    //    {
    //        get
